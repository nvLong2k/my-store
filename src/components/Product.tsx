            ...
            <div className="relative aspect-square bg-[#f5f4f0] overflow-hidden">
                ...
                <button
                    onClick={(e) => {
                        e.preventDefault();
                        e.stopPropagation();
                        router.push(`/products/${product.id}/design`);
                    }}
                    className="absolute inset-x-0 bottom-4 flex justify-center opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 z-10 hover:text-orange-500 hover:cursor-pointer">
