        ...
        <div className="sticky top-0 z-30 bg-white/95 backdrop-blur border-b border-gray-200">
            <div className="max-w-7xl mx-auto px-4 relative">
                ...
                <div className="hidden md:flex items-center gap-2 py-3">
                    <Link
                        href="/"
                        className="px-4 py-2 rounded-full text-sm font-medium border border-gray-200 hover:bg-black hover:text-white transition"
                    >
                        All products
                    </Link>
                ...
                {/* Mobile dropdown */}
                <div className={`md:hidden absolute top-full right-0 w-64 bg-white border border-gray-200 rounded-xl shadow-lg p-2 overflow-hidden transition-all duration-200 ${openMenu
